...
class LeaveRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'reason'     => 'required_if:type,izin|nullable|string|max:1000',
            'attachment' => 'required_if:type,sakit|nullable|file|mimes:jpg,jpeg,png,pdf|max:5120',
        ], [
            'start_date.after_or_equal' => 'Tanggal mulai tidak boleh sebelum hari ini.',
            'end_date.after_or_equal'   => 'Tanggal selesai tidak boleh sebelum tanggal mulai.',
            'reason.required_if'        => 'Alasan wajib diisi.',
            'attachment.required_if'    => 'Surat keterangan sakit dari dokter wajib diunggah untuk izin sakit.',
        ]);
